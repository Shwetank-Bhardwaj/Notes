...
public class BaseRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        try{
            doOnCreateViewHolder(parent, viewType);
        }catch (Exception e){
            sendLog(e);
        }
        return null;
    ...
    private void doOnCreateViewHolder(ViewGroup parent, int viewType) {

    }

    private void doOnBindViewHolder(RecyclerView.ViewHolder holder, int position) {
